...
\begin{description}
\item[Air Squared]
\item[Termo2Power] Working fluid: R245fa
\item[Climeon]
\item[Calnetix/Access Energy] Working fluid: R245fa
...
\item[Inifinity Turbine] 50kW Working fluid: R245fa -- 10kW Working fluid: supercritical $CO_2$
\item[Ener-G-Rotors]
\item[Phoenix] Working fluid: R245fa
\end{description}
\subsubsection{Commercial Products}
\begin{description}
\item[Electratherm] makes use of a twin screw expander to spin an induction generator.  Working fluid: R245fa
\item[E-Rationale] uses a single screw expander to rotate an induction generator. Working fluid: R245fa or SES36
...
\item[Enogia] uses a turboexpander. Electric power is rectified then tied into the grid with a grid feed inverter. Working fluid: R245fa
\item[Clean Energy Technologies] %uses high speed turbine. Working fluid: R245fa
