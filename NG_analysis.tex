...
plots the heat flow rates though the evaporator, $\dot{Q}_{evap}$, and condenser,  $\dot{Q}_{cond}$. The inlet and outlet temperatures of the source fluid, $T_{source\ in}$ and $T_{source\ out}$, and sink fluid, $T_{sink\ in}$ and $T_{sink\ out}$, are plotted in \autoref{fig:verificationWaterTemp01}. \input{figures/VerificationWaterTemp01} 
