...
%In a simple Boost converter, seen in fig X, timed switching also sets the average output voltage to the desire level. However, the placement of the inductor ensures ensures a continuous current at the output and the capacitor provides a steady voltage. Example waveforms of input and output current and voltage can be seen for a simple buck converter in fig X.
